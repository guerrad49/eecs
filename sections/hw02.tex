...
\begin{multicols}{3}
	\hfill   % Flush right.
	\includestandalone[mode=buildmissing, scale=0.75]
		{figures/simple_des_enc}

	\begin{center}
	\begin{tabular}{ c | c | c }
		\textbf{Round} & $L_i$ & $R_i$ \\[2pt]  % Extra height.
		\hline
		IP & $L_0$ & $R_0$ \\[5pt]
		 1 & $R_0$ & $L_0$ \\[5pt]
		 2 & $L_0$ & $R_0$ \\[5pt]
...
\begin{multicols}{2}
	...
	\begin{tabular}{ c | c | c | c }
		\textbf{Round} & $L_i$ & $R_i$ & Simplified \\[2pt]  % Extra height.
		\hline
		IP & $L_0$ & $R_0$            &       \\[5pt]
	...
	\begin{center}
	\begin{tabular}{ c | c | c | c }
		\textbf{Round} & $L_i$ & Simplified & $R_i$ \\[2pt]  % Extra height.
		\hline
		16 &               $R_0$ &          & $R_1$    \\[5pt]
...
% ==== NOTES ====
\begin{solution}
Note that all the code in Problem 4.11 is located in \purpText{scripts/des.c} 
