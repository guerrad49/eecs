...
The file \purpText{scripts/show\_outputs.c} is used to generate the frequency 
distribution.
...
using functions from \purpText{scripts/ioc.c}.
...
using \purpText{scripts/ioc.c} (relevant parts shown below). Note that in 
...
Decrypt using \purpText{scripts/ioc.c} shown above and reformat to attain the 
...
as shown below from \purpText{scripts/show\_outputs.c}.
